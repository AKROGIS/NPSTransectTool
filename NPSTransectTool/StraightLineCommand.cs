...
{
    /// <summary>
    /// Summary description for StraightLineCommand.
    /// </summary>
    [Guid("020ab206-3bdf-4f60-a2e0-9243bdba0021")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("NPSTransectTool.StraightLineCommand")]
    public sealed class StraightLineCommand : BaseCommand
    {
        ...
        public override bool Enabled
        {
            get
            {
                return NPSGlobal.Instance.IsInitialized;
                //return base.Enabled;
            }
        }
